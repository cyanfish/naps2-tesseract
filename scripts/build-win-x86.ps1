...
$TARGET_DIR="$ARTIFACTS_DIR/win-x86"

pushd "$SOURCES_DIR/tesseract"
rm -Recurse -Force build
mkdir build
pushd "build"
. cmake .. -DDISABLED_LEGACY_ENGINE=ON -DBUILD_TRAINING_TOOLS=OFF  -DCMAKE_SYSTEM_VERSION=7 -DBUILD_SHARED_LIBS=OFF -DGRAPHICS_DISABLED=ON -DENABLE_LTO=ON -A Win32
